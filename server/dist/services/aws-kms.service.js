...
class AwsKmsService {
    ...
    async getSigner(keyId) {
        ...
        const hederaPublicKey = this.spkiToHederaPublicKey(pkResponse.PublicKey);
        const sign = async (bytes) => {
            ...
            return this.derToRaw(sigResponse.Signature);
        };
        const signer = { hederaPublicKey, sign };
