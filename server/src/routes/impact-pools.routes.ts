...
import {
  createImpactPoolSchema,
  impactPoolParamsSchema,
} from "../schemas/impact-pool.schema.js";
...
impactPoolsRouter.post(
  "/impact-pools",
  validateRequest(createImpactPoolSchema),
...
impactPoolsRouter.get(
  "/impact-pools/:id",
  validateRequest(impactPoolParamsSchema),
  async (request, response) => {
