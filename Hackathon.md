...
AI & Agents (Main Track Submission)
...
Challenge Statements
Sustainability (Main Track Submission)
Theme 4: Open Track
...
Challenge Statements
Open Track (Main Track Submission)
...
Challenge Statements
Legacy Builders (Main Track Submission)
Timeline
...
Judging Period – 24 March to 17 April
...
This is the URL to the project demo video of the solution the team has developed. A submission without a demo video link will not be scored. (Maximum length: 5 minutes)
...
Submit between Feb 17 – Mar 23, 11:59PM ET
Must be a registered Apex hackathon participant
Open to individual participants only
Use your StackUp username on ZEP. Type it correctly on the form.
...
https://hol.org/registry/skill.md
https://hol.org/registry/moltbook
...
https://go.hellofuturehackathon.dev/apex-rules